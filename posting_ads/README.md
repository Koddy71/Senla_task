...
- историю продаж;
- блокировку и восстановление объявлений для администратора и менеджера.
...
- просмотр и изменение данных пользователей;
...
- Каждый сервис хранит свою базу данных отдельно.
